...
export default function PersonnelOverview() {
  ...
  const [patientName, setPatientName] = useState('Rachel Cash');
  const [patientId, setPatientId] = useState('VA-2025-789');
  const navigate = useNavigate();

  useEffect(() => {
    if (userData?.profile) {
      setPatientName(userData.profile.name || 'Rachel Cash');
    }
  }, [userData]);
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm">
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">ID: {patientId} • DOB: 05/15/1995</p>
              </div>
            </div>
